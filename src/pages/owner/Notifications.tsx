...
import { BellIcon, ChevronLeft, EditIcon, HeadsetIcon, BarChart3Icon, CarIcon, UserIcon } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      {loading ? (
        ...
        <div className="space-y-3 max-h-[80vh] overflow-y-auto mb-20 pr-2">
          <ul>
    ...
    <div>
      <header className="md:hidden bg-gray-100 shadow sticky top-0 z-40 p-2 flex items-center justify-between">
        ...
        <div className="flex gap-2 mt-2 justify-end flex-1">
          <button
            className={`px-4 py-2 rounded-t flex font-semibold border-b-2 ${tab === 'notifs' ? 'border-black text-black-700 bg-white' : 'border-transparent text-gray-500 bg-gray-100'}`}
          ...
          <button
            className={`px-4 py-2 rounded-t flex font-semibold border-b-2 ${tab === 'conversations' ? 'border-black text-black bg-white' : 'border-transparent text-gray-500 bg-gray-100'}`}
          ...
          <button
            className={`px-4 py-2 rounded-t flex font-semibold border-b-2 ${tab === 'feedback' ? 'border-black text-black bg-white' : 'border-transparent text-gray-500 bg-gray-100'}`}
