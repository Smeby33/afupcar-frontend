          ...
          <div className="text-gray-800 space-y-2 text-sm">
            ...
            <ol className="list-decimal ml-6 space-y-1">
              ...
              <li>
                ...
                <ul className="list-disc ml-6">
                  <li>Le montant de la location est collecté par Lotu Auto. La plateforme reverse les fonds aux propriétaires déduction faite de la commission convenue.</li>
              ...
              <li>
                ...
                <ul className="list-disc ml-6">
                  <li>Lotu Auto gère le dépôt de garantie selon le type de véhicule. En cas de dommage, le propriétaire doit soumettre les justificatifs pour une éventuelle retenue.</li>
                </ul>
              </li>
              <li>
                <b>Responsabilités</b>
              ...
              <li>
                <b>Résiliation</b>
                <ul className="list-disc ml-6">
                  <li>Lotu Auto peut suspendre ou résilier un compte propriétaire en cas de non-respect des présentes CGU ou de plaintes répétées de locataires.</li>
                </ul>
              </li>
            </ol>
          </div>
